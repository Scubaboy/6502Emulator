...
public class CPX : IOptCode
{
    ...
    public CPX(IRegisters registers, ICPUBus cPUBus)
    {
    ...
    public byte Execute(ushort address)
    {
        ...
        var result = (ushort)_registers.X.Value - (ushort)data;
        
        RegisterUtils.SetRegisterBit(_registers.Status, (byte)StatusRegister.StatusBits.C, _registers.X.Value >= data);
